...
def fetch_financial_statements(symbols: list[str], source: str, mock: bool = False) -> pd.DataFrame:
    if mock:
        rows = [
            {"symbol": "FPT", "report_period": "2024-Q4", "revenue": 1200000.0, "profit": 150000.0, "pe_ratio": 16.2, "pb_ratio": 1.8, "roe": 0.28, "roa": 0.12, "net_margin": 0.125, "debt_to_equity": 0.9, "market_cap": 1.9e14, "shares_outstanding": 1.47e9, "source": source.upper()},
            {"symbol": "HPG", "report_period": "2024-Q4", "revenue": 800000.0, "profit": 95000.0, "pe_ratio": 12.5, "pb_ratio": 1.1, "roe": 0.11, "roa": 0.06, "net_margin": 0.119, "debt_to_equity": 0.8, "market_cap": 1.7e14, "shares_outstanding": 6.4e9, "source": source.upper()},
        ]
